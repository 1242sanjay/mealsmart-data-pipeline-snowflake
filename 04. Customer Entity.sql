...
list @mealsmart_db.stage_sch.mealsmart_csv_stg/customer/initial-load/;

select $1, $2, $3, $4, $5, $6, $7
from @mealsmart_db.stage_sch.mealsmart_csv_stg/customer/initial-load/customers-initial.csv
...
from (
    ...
    from @mealsmart_db.stage_sch.mealsmart_csv_stg/customer/initial-load/customers-initial.csv t
)
...
CREATE OR REPLACE TABLE CONSUMPTION_SCH.CUSTOMER_DIM (
    CUSTOMER_HK NUMBER PRIMARY KEY COMMENT 'Surrogate key for the customer',
    CUSTOMER_ID STRING NOT NULL COMMENT 'Natural key for the customer',
    NAME STRING(100) NOT NULL COMMENT 'Customer name',
    MOBILE STRING(15) WITH TAG (common.pii_policy_tag = 'PII') COMMENT 'Mobile number',
    EMAIL STRING(100) WITH TAG (common.pii_policy_tag = 'EMAIL') COMMENT 'Email',
    LOGIN_BY_USING STRING(50) COMMENT 'Method of login',
    GENDER STRING(10) WITH TAG (common.pii_policy_tag = 'PII') COMMENT 'Gender', 
    DOB DATE WITH TAG (common.pii_policy_tag = 'PII') COMMENT 'Date of birth',
    ANNIVERSARY DATE COMMENT 'Anniversary',
    PREFERENCES STRING COMMENT 'Preferences',
    EFF_START_DATE TIMESTAMP_TZ COMMENT 'Effective start date',
    EFF_END_DATE TIMESTAMP_TZ COMMENT 'Effective end date (NULL if active)',
    IS_CURRENT BOOLEAN COMMENT 'Flag to indicate the current record'
)
