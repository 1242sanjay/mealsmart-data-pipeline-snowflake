...
list @mealsmart_db.stage_sch.mealsmart_csv_stg/customer-address/initial-load/;

select $1, $2, $3, $4, $5, $6, $7
from @mealsmart_db.stage_sch.mealsmart_csv_stg/customer-address/initial-load/customer_address_book_initial.csv
...
from (
    ...
    from @mealsmart_db.stage_sch.mealsmart_csv_stg/customer-address/initial-load/ t
)
...
CREATE OR REPLACE TABLE CONSUMPTION_SCH.CUSTOMER_ADDRESS_DIM (
    ...
    FLAT_NO STRING COMMENT 'Flat number',
    HOUSE_NO STRING COMMENT 'House number',
    FLOOR STRING COMMENT 'Floor',
    BUILDING STRING COMMENT 'Building name',
    LANDMARK STRING COMMENT 'Landmark',
    LOCALITY STRING COMMENT 'Locality',
    CITY STRING COMMENT 'City',
    STATE STRING COMMENT 'State',
    PINCODE STRING COMMENT 'Pincode',
    COORDINATES STRING COMMENT 'Geo-coordinates',
    PRIMARY_FLAG STRING COMMENT 'Whether it\'s the primary address',
    ADDRESS_TYPE STRING COMMENT 'Type of address (e.g., Home, Office)',
