...
list @mealsmart_db.stage_sch.mealsmart_csv_stg/menu/initial-load/;

select $1, $2, $3, $4, $5, $6, $7
from @mealsmart_db.stage_sch.mealsmart_csv_stg/menu/initial-load/menu-initial-load.csv
...
from (
    ...
    from @mealsmart_db.stage_sch.mealsmart_csv_stg/menu/initial-load/ t
)
...
CREATE OR REPLACE TABLE consumption_sch.menu_dim (
    ...
    Description STRING COMMENT 'Description of the menu item',
    Price DECIMAL(10, 2) COMMENT 'Price as a numeric value with 2 decimal places',
    Category STRING COMMENT 'Food category (e.g., North Indian)',
    Availability BOOLEAN COMMENT 'Availability status (True/False)',
    Item_Type STRING COMMENT 'Dietary classification (e.g., Vegan)',
    EFF_START_DATE TIMESTAMP_NTZ COMMENT 'Effective start date of the record',
    EFF_END_DATE TIMESTAMP_NTZ COMMENT 'Effective end date of the record',
    IS_CURRENT BOOLEAN COMMENT 'Flag to indicate if the record is current (True/False)'
)
