...
list @mealsmart_db.stage_sch.mealsmart_csv_stg/order-item/initial-load;

select $1, $2, $3, $4, $5, $6, $7
from @mealsmart_db.stage_sch.mealsmart_csv_stg/order-item/initial-load/order-Item-initial.csv
...
from (
    ...
    from @mealsmart_db.stage_sch.mealsmart_csv_stg/order-item/initial-load t
)
